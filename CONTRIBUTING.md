...
Each project has its own contribution guide tailored to that project's conventions, scope, and review process:

| Project | Guide |
|---|---|
| **OCAS** (Open Charity API Standard) | [`open-charity-api/docs/contributing.md`](./open-charity-api/docs/contributing.md) |

When future projects are added, they will appear in this table with links to their own guides.

## Ways to help

A few categories are especially welcome across all projects:
...
- Discussions and design happen openly. Surprise PRs that rewrite large surfaces tend to stall; an RFC discussion first dramatically improves your odds.
- We follow the [Contributor Covenant v2.1](./CODE_OF_CONDUCT.md), with one explicit additional norm: **no proselytising, in any direction.** Keep the work technical; keep the spirit welcoming.
- All contributions are licensed under [Apache 2.0](./LICENSE) by default. By opening a PR you agree your contribution is licensed accordingly.

## Reporting security issues

Don't open public issues for vulnerabilities. See [`SECURITY.md`](./SECURITY.md) for the private disclosure process.

## Questions?

Open a Discussion under "Q&A". For project-specific questions, link the relevant project's guide.
